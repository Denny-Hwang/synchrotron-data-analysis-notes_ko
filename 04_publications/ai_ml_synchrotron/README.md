...
(2023-2024)을 아우르며, 빔라인 과학에 적용 가능한 AI/ML 역량의 포괄적인
전경을 제공합니다.
...
| `review_fullstack_dl_tomo_2023.md` | Fundamental Research (2023) | 방사광 토모그래피 파이프라인을 위한 풀스택 DL 비전 |
...
| `review_ai_edge_ptychography_2023.md` | Babu et al., Nature Comm. (2023) | 타이코그래피 이미징을 위한 실시간 피드백 루프 |
...
| 리뷰 | 논문 | 주요 기여 |
|------|------|-----------|
| `review_fullstack_dl_tomo_2023.md` | Fundamental Research (2023) | 토모그래피 전 단계에 걸친 포괄적 파이프라인 비전 |
...
| 6 | `review_ai_edge_ptychography_2023.md` | Babu | 2023 | 타이코그래피 |
| 7 | `review_fullstack_dl_tomo_2023.md` | Wang | 2023 | 토모그래피 |
| 8 | `review_deep_residual_xrf_2023.md` | Zhang | 2023 | XRF |
| 9 | `review_ai_nerd_2024.md` | Horwath | 2024 | XPCS |
| 10 | `review_ai_als_workshop_2024.md` | ALS Working Group | 2024 | 다중 모달 |
...
5. **`review_ai_edge_ptychography_2023.md`** 및
...
7. **`review_ai_nerd_2024.md`** -- 최첨단에서의 동역학을 위한 비지도 방법을
   다룹니다.
