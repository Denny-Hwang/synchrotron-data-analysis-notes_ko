...
04_publications, and 09_noise_catalog as cards.
...
render_header()
render_breadcrumb([("Home", "/"), ("Explore the Science", None)])

meta = CLUSTER_META["explore"]
st.markdown(
...
cluster_folders = set(get_folders_for_cluster("explore"))
cluster_notes = [n for n in all_notes if n.folder in cluster_folders]

# Group by folder for sub-navigation
